...
CREATE TABLE if NOT EXISTS estanteria (
    ...
    "fecha_inicio" date NOT NULL, --solo el dia de instalacion
    "id_almacen" char(10),
...
CREATE TABLE IF NOT EXISTS rutas(
    ...
    ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT vnn_inicio_rutas_fk FOREIGN KEY ("vnn_inicio") REFERENCES estanteria
    ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT vnn_destino_rutas_fk FOREIGN KEY ("vnn_destino") REFERENCES estanteria
    ON DELETE CASCADE ON UPDATE CASCADE
)
