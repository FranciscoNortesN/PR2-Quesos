...
cinta = RDK.Item('MecanismoGiraQuesos', ITEM_TYPE_ROBOT)

if not cinta.Valid():
    RDK.ShowMessage("Error: No se encontró un mecanismo llamado 'MecanismoGiraQuesos'.")
    exit()

# Definir las juntas iniciales (reset a 0)
juntas_iniciales = [-360]  # Suponemos que la cinta tiene una sola articulación
